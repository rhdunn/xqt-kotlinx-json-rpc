...
class TheJsonElementType {
    ...
    fun supports_the_array_kind_type() {
        assertEquals(jsonArrayOf(), JsonElement.serializeToJson(jsonArrayOf()))
        assertEquals(jsonArrayOf(), JsonElement.deserialize(jsonArrayOf()))

        val array = jsonArrayOf(JsonPrimitive(1234))
        assertEquals(array, JsonElement.serializeToJson(array))
    ...
    fun supports_the_object_kind_type() {
        assertEquals(jsonObjectOf(), JsonElement.serializeToJson(jsonObjectOf()))
        assertEquals(jsonObjectOf(), JsonElement.deserialize(jsonObjectOf()))

        val `object` = jsonObjectOf("test" to JsonPrimitive(1234))
        assertEquals(`object`, JsonElement.serializeToJson(`object`))
    ...
    fun supports_the_null_kind_type() {
        assertEquals(JsonNull, JsonElement.serializeToJson(JsonNull))
    ...
    fun supports_the_string_kind_type() {
        assertEquals(JsonPrimitive("lorem ipsum"), JsonElement.serializeToJson(JsonPrimitive("lorem ipsum")))
    ...
    fun supports_the_boolean_kind_type() {
        assertEquals(JsonPrimitive(true), JsonElement.serializeToJson(JsonPrimitive(true)))
        assertEquals(JsonPrimitive(true), JsonElement.deserialize(JsonPrimitive(true)))

        assertEquals(JsonPrimitive(false), JsonElement.serializeToJson(JsonPrimitive(false)))
    ...
    fun supports_the_integer_kind_type() {
        assertEquals(JsonPrimitive(1234), JsonElement.serializeToJson(JsonPrimitive(1234)))
        assertEquals(JsonPrimitive(1234), JsonElement.deserialize(JsonPrimitive(1234)))

        assertEquals(JsonPrimitive(Long.MIN_VALUE), JsonElement.serializeToJson(JsonPrimitive(Long.MIN_VALUE)))
        assertEquals(JsonPrimitive(Long.MIN_VALUE), JsonElement.deserialize(JsonPrimitive(Long.MIN_VALUE)))

        assertEquals(JsonPrimitive(Long.MAX_VALUE), JsonElement.serializeToJson(JsonPrimitive(Long.MAX_VALUE)))
    ...
    fun supports_the_decimal_kind_type() {
        assertEquals(JsonPrimitive(1.2), JsonElement.serializeToJson(JsonPrimitive(1.2)))
        assertEquals(JsonPrimitive(1.2), JsonElement.deserialize(JsonPrimitive(1.2)))

        assertEquals(JsonPrimitive(Double.MIN_VALUE), JsonElement.serializeToJson(JsonPrimitive(Double.MIN_VALUE)))
        assertEquals(JsonPrimitive(Double.MIN_VALUE), JsonElement.deserialize(JsonPrimitive(Double.MIN_VALUE)))

        assertEquals(JsonPrimitive(Double.MAX_VALUE), JsonElement.serializeToJson(JsonPrimitive(Double.MAX_VALUE)))
